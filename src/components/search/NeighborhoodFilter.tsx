 ...
 *
 * Desktop: 4 botões lado a lado. Mobile: grid 2x2.
 */
      ...
      {neighborhoods.map((neighborhood) => {
        ...
        return (
          <button
            ...
            className={`flex h-[90px] w-[163px] items-center justify-center rounded-lg p-2 text-center font-display text-[26px] font-bold uppercase tracking-[0.78px] ${
              isSelected
